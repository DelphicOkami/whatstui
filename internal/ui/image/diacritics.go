...
// rowColumnDiacritics is the canonical kitty row/column diacritic table.
// Index N maps to a specific combining codepoint; the kitty terminal decodes
// these as "this placeholder cell is at row/column N" (0-based).
//
// Source: kitty's rowcolumn-diacritics.txt (297 entries).
